...
.ftco-intro {
  ...
  .ftco-intro:after {
    ...
    background: #233e62;
    background: #da0d0d;
    background: -moz-linear-gradient(left, #da0d0d 0%, #bd0404 100%);
    background: -webkit-gradient(left top, right top, color-stop(0%, #da0d0d), color-stop(100%, #bd0404));
    background: -webkit-linear-gradient(left, #da0d0d 0%, #bd0404 100%);
    background: -o-linear-gradient(left, #da0d0d 0%, #bd0404 100%);
    background: -ms-linear-gradient(left, #da0d0d 0%, #bd0404 100%);
    background: -webkit-gradient(linear, left top, right top, from(#da0d0d), to(#bd0404));
    background: linear-gradient(to right, #da0d0d 0%, #bd0404 100%);
    filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#da0d0d', endColorstr='#bd0404', GradientType=1 ); }
  .ftco-intro .btn {
    width: 100%; }
  .ftco-intro h2 {
    line-height: 1.2; }
